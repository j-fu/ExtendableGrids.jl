...
generates a new ExtendableGrid by uniform refinement (nrefinements number of times) of each cell in the given grid
...
struct RefinementRule{RRT, EG, Tv} <: AbstractRefinementRule
    new_cell_points::Array{Array{Tv,1},1}               # new interior points in weights of cell nodes (will become last new nodes)
    new_face_points::Array{Array{Tv,1},1}               # new face points in weights of face nodes (will become second new nodes)
    new_edge_points::Array{Array{Tv,1},1}               # new edge points in weights of edge nodes (will become first new nodes)
